...
export default function Invoices() {
  ...
  return (
    <DashboardLayout title="Invoices" description="Admin-created invoices for client funding charges">
                ...
                {filtered.map((inv) => (
                  <tr key={String(inv.id ?? inv.invoice_number)} className="border-t border-slate-200 dark:border-slate-700">
                    ...
                    <td className="p-3 text-right space-x-2">
                      ...
                      <Button variant="default" size="sm" onClick={() => handleView(inv)}>View</Button>
                    </td>
                  </tr>
                ))}
                {filtered.length === 0 && (
