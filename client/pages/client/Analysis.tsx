      ...
      <div className="mb-6">
        ...
        {/* Comprehensive Credit Analysis Report */}
          ...
          <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-xl sm:text-2xl md:text-3xl font-bold text-blue-800">
                <BarChart3 className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-blue-600" />
                Your Current Credit Status
              </CardTitle>
              <CardDescription className="text-sm sm:text-base md:text-lg text-blue-700">
            ...
            <CardContent className="space-y-6 sm:space-y-8">
              ...
              <div className="bg-white rounded-xl p-4 sm:p-6 border border-blue-200 shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                  <div className="text-center">
                    <div className="w-14 h-7 sm:w-16 sm:h-8 bg-blue-600 rounded text-white flex items-center justify-center mx-auto mb-3 text-xs sm:text-sm font-bold">
                      TU
                    </div>
                    <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-blue-600 mb-2">
                      769
                    </div>
                    <div className="text-xs sm:text-sm text-gray-600 mb-1">TransUnion</div>
                    <div className="text-[11px] sm:text-xs text-blue-600">2024-10-31</div>
                  </div>
                  <div className="text-center">
                    <div className="w-14 h-7 sm:w-16 sm:h-8 bg-green-600 rounded text-white flex items-center justify-center mx-auto mb-3 text-xs sm:text-sm font-bold">
                      EX
                    </div>
                    <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-green-600 mb-2">
                      775
                    </div>
                    <div className="text-xs sm:text-sm text-gray-600 mb-1">Experian</div>
                    <div className="text-[11px] sm:text-xs text-green-600">2024-10-31</div>
                  </div>
                  <div className="text-center">
                    <div className="w-14 h-7 sm:w-16 sm:h-8 bg-purple-600 rounded text-white flex items-center justify-center mx-auto mb-3 text-xs sm:text-sm font-bold">
                      EQ
                    </div>
                    <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-purple-600 mb-2">
                      772
                    </div>
                    <div className="text-xs sm:text-sm text-gray-600 mb-1">Equifax</div>
                    <div className="text-[11px] sm:text-xs text-purple-600">2024-10-31</div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-20 sm:w-24 md:w-32 h-2 bg-gray-200 rounded-full overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className="space-y-3">
                    {(() => {
                      ...
                      return (
                        <>
                          <div className="flex justify-between items-center">
                            <span className="text-xs sm:text-sm text-gray-700">Inquiries:</span>
                            <span className={`font-bold ${inqColor}`}>{inqCount}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-xs sm:text-sm text-gray-700">Late Payments:</span>
                ...
                <div className="bg-white rounded-xl p-4 sm:p-6 border border-blue-200 shadow-sm">
                  ...
                  <div className="space-y-2">
                    ...
                    })()} rounded-lg p-2 sm:p-3 text-center`}>
          ...
          <Card className="border-0 shadow-xl bg-gradient-to-br from-orange-50 via-yellow-50 to-amber-50">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-xl sm:text-2xl md:text-3xl font-bold text-orange-800">
                <Search className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-orange-600" />
                Recent Inquiries
              </CardTitle>
              <CardDescription className="text-sm sm:text-base md:text-lg text-orange-700">
            ...
            <CardContent>
              <div className="bg-white rounded-xl border border-orange-200 overflow-x-auto">
                <Table className="w-full min-w-[640px] text-xs sm:text-sm">
                  <TableHeader>
                    <TableRow>
                      <TableHead className="whitespace-nowrap">Creditor Name</TableHead>
                      <TableHead className="whitespace-nowrap">Bureau</TableHead>
                      <TableHead className="whitespace-nowrap">Date Inquiry</TableHead>
                        ...
                        .map((inq: any, idx: number) => {
                          ...
                          return (
                            <TableRow key={`inq-${idx}`}>
                              <TableCell className="font-medium text-gray-800 break-words">{creditor}</TableCell>
          ...
          {/* Negative Aspects - Bad Accounts */}
          <Card className="border-0 shadow-xl bg-gradient-to-br from-red-50 via-rose-50 to-pink-50">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-xl sm:text-2xl md:text-3xl font-bold text-red-800">
                <ThumbsDown className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-red-600" />
                Bad Accounts
              </CardTitle>
              <CardDescription className="text-sm sm:text-base md:text-lg text-red-700">
                ...
                <Table className="w-full min-w-[720px] text-xs sm:text-sm">
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="whitespace-nowrap text-right">Current Balance</TableHead>
                      <TableHead className="whitespace-nowrap text-right">Credit Limit</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
          ...
          {/* Positive Aspects - Good Standing Accounts */}
          <Card className="border-0 shadow-xl bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-xl sm:text-2xl md:text-3xl font-bold text-green-800">
                <ThumbsUp className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-green-600" />
                Good Standing Accounts
              </CardTitle>
              <CardDescription className="text-sm sm:text-base md:text-lg text-green-700">
          ...
          <Card className="border-0 shadow-xl bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-xl sm:text-2xl md:text-3xl font-bold text-orange-800">
                <AlertTriangle className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-orange-600" />
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-3 sm:space-y-4">
                  <div className="bg-white rounded-lg p-3 sm:p-4 border border-orange-200">
                    <div className="flex items-start gap-2 sm:gap-3">
                      <CheckCircle className="h-5 w-5 sm:h-6 sm:w-6 text-green-600 mt-1" />
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2">
                  ...
                  <div className="bg-white rounded-lg p-3 sm:p-4 border border-orange-200">
                    <div className="flex items-start gap-2 sm:gap-3">
                      <Clock className="h-5 w-5 sm:h-6 sm:w-6 text-blue-600 mt-1" />
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2">
                          Avoid Late Payments
                        </h4>
                  ...
                  <div className="bg-white rounded-lg p-3 sm:p-4 border border-orange-200">
                    <div className="flex items-start gap-2 sm:gap-3">
                      <CreditCard className="h-5 w-5 sm:h-6 sm:w-6 text-purple-600 mt-1" />
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="bg-white rounded-lg p-3 sm:p-4 border border-orange-200">
                    <div className="flex items-start gap-2 sm:gap-3">
                      <Search className="h-5 w-5 sm:h-6 sm:w-6 text-orange-600 mt-1" />
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2">
                  ...
                  <div className="bg-white rounded-lg p-3 sm:p-4 border border-orange-200">
                    <div className="flex items-start gap-2 sm:gap-3">
                      <Shield className="h-5 w-5 sm:h-6 sm:w-6 text-teal-600 mt-1" />
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2">
                  ...
                  <div className="bg-white rounded-lg p-3 sm:p-4 border border-orange-200">
                    <div className="flex items-start gap-2 sm:gap-3">
                      <BarChart className="h-5 w-5 sm:h-6 sm:w-6 text-indigo-600 mt-1" />
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2">
